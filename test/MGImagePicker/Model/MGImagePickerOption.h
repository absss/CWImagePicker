...
typedef NS_ENUM(NSInteger, MGImagePickerControllerSourceType) {
    MGImagePickerControllerSourceTypeCamera,
    UIImagePickerControllerSourceTypeAlbum
};
@interface MGImagePickerOption : NSObject
...
//默认选择相册
@property(nonatomic,assign)MGImagePickerControllerSourceType sourceType;
/**
 最大允许选择多少张，默认9张
 */
