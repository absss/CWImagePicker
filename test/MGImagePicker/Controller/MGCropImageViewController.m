...
@interface MGCropImageViewController ()
...
@implementation MGCropImageViewController

- (id)initWithImage:(UIImage *)originalImage cropFrame:(CGRect)cropFrame limitScaleRatio:(NSInteger)limitRatio {
    self = [super init];
    if (self) {
        UIEdgeInsets insets = [MGImagePickerHandler shareIntance].option.cropFrameInsets;
...
- (UIImage *)clipImage{
    //截取全屏
    UIGraphicsBeginImageContext(CGSizeMake(MGScreenWidth, MGScreenHeight));
